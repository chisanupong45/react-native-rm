export const TOP_PLACES = [
    {
      id: 1,
      image: require('../assets/images/ant2.jpeg'),
      title: 'Ant',
      location: 'Formicidae',
      description:
    ...
    {
      id: 2,
      image: require('../assets/images/Ant_Formicidae.jpeg'),
      title: 'Ant',
      location: 'Formicidae',
      description:
    ...
    {
      id: 3,
      image: require('../assets/images/m2_one.jpeg'),
      title: 'แมลงวัน',
      location: 'Formicidae',
      description:
  ...
  export const PLACES = [
    ...
    {
      id: 5,
      image: require('../assets/images/D_Cicindela chinensis.jpeg'), 
      title: 'Duang',
      location: 'Cicindela chinensis',
      description:
    ...
    {
      id: 6,
      image: require('../assets/images/ps_n_Plodia Interpunctella.jpeg'), 
      title: 'Duang',
      location: 'Endomychinae',
      description:
    ...
    {
      id: 7,
      image: require('../assets/images/ps4_n_Plodia Interpunctella.jpeg'), 
      title: 'Duang',
      location: 'Endomychinae',
      description:
